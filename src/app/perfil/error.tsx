...
export default function PerfilError({ error: _error, reset }: ErrorProps) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-text mb-2">Não foi possível carregar seu perfil.</h1>
